      ...
      const questionData = [
        {
          ...
          answer: "現時會員可於我們的分店 (請出示您的電子會員卡) 或 手機App內以積分換領禮品。"
        },
        {
          id: 2,
          category: "會員",
        ...
        },
        {
          ...
          category: "會員",
          question: "成為會員有什麼優惠?",
          answer: "會員於店鋪內購物(指定貨品除外)均可獲得積分，並可以積分換領精彩禮品。同時可參與不定期舉行之各種優惠活動，優先收取有關最新產品資訊及優惠。"
        },
        {
          id: 4,
          category: "會員",
          question: "會員如何儲分?",
          answer: "會員於購物時，只需出示會員卡(如網上購物，須登入會員)，便可以為該次購物儲分(指定貨品除外)。"
        },
        {
          id: 5,
          category: "會員",
        ...
        },
        {
          ...
          answer: "會籍沒有限期。所有積分的有效期以獲得日期起計，至翌年12月31日，逾期無效到期。例如：於2017年所有取得積分均於2018年12月31日到期，到期積分將不獲補發或延期。"
        },
        {
          id: 7,
          category: "會員",
        ...
        },
        {
          ...
          answer: "您於任何移動裝置下載手機應用程式後，便可隨時登入會員系統查看積分。您亦可方便你於購物時即時登入會員系統，出示您的電子會員咭即時儲分或換領禮品。"
        },
        {
          id: 10,
          category: "會員",
          question: "我可以在哪裡找到會員卡號碼?",
          answer: "你可登入手機應用程式，按\"二維碼\"圖標，即可看到以E字為首的會員卡號碼。"
        }
      ];
